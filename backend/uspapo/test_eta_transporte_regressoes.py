...
from uspapo.transporte import previsoes, consultas_circulares as circulares
...
class RegressaoEtaGpsCircularTests(unittest.TestCase):
    def test_regressao_no_shape_depois_do_alvo_nao_descarta_eta_antes_do_alvo(self):
        ...
        with (
            patch.object(previsoes, "_instante_referencia_sptrans", return_value=referencia),
            patch.object(previsoes, "_shape_da_viagem", return_value=shape),
            patch.object(
                previsoes,
    ...
    def test_ramos_circulares_geograficamente_ambiguos_recusam_eta(self):
        ...
        with (
            patch.object(previsoes, "_instante_referencia_sptrans",
...
class RegressaoDedupeVeiculosTests(unittest.TestCase):
    def test_hr_antigo_descarta_payload_inteiro_ainda_que_ta_seja_coerente(self):
        ...
        with patch.object(previsoes, "_agora_sptrans", return_value=agora):
