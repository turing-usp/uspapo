...
- Use o MÍNIMO de chamadas de ferramenta possível: em geral uma busca bem formulada resolve. Nunca repita uma consulta que você já fez, e se duas ou três tentativas não trouxerem o fato, pare de tentar e responda que não encontrou.
