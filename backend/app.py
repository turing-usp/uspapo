...
from uspapo.ferramentas import bandejao, busca, curriculo, disciplinas, uspavalia
from uspapo.web import criar_app, rodar

# Cardápio, disciplinas, grade curricular e avaliações são iguais nos dois
# backends: vêm do RUCard, do JupiterWeb e do USP Avalia ao vivo, não do
# Pinecone, então as mesmas ferramentas entram nos dois registros. Antes do
